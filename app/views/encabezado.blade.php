<nav class="navbar navbar-expand-md navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ BASE_URL }}"><img src="../../assets/img/logo.png"
                class="img-responsive img-thumbnail" alt="Desatranques Jaén"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="btn-group">
                <a class="nav-link dropdown-toggle text-primary" href="#" id="usuarioDropdown" role="button"
